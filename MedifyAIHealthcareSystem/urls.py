...
from MedifyAIHealthcareSystem import views as mainView
...
urlpatterns = [
    ...
    path("medify_llm_results/", usr.medify_llm_results, name="medify_llm_results"),
    path("symptom_checker-checker/", usr.symptom_checker, name="symptom_checker"),
